...
```{r lineplots-final-result,fig.width=6,fig.height=6}
...
```{r frequency-table-VLE-final-result,fig.height=2,fig.width=2}
...
```{r combined-clicks-ass,fig.height=3,fig.width=5}
...
```{r result-combine-logistic-wothdrawal}
...
```{r semesterB-total-score, eval=FALSE}
...
```{r semesterJ-total-score, eval=FALSE}
